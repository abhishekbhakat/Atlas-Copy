...
@REM type "!windir!\Resources\Themes\aero.theme" | findstr /c:"AppMode="
@REM if !errorlevel! == 0 (
...
@REM ) else (
@REM 	PowerShell -NoP -C "$Content = (Get-Content '!windir!\Resources\Themes\aero.theme'); $Content = $Content -replace 'Wallpaper=%%SystemRoot%%.*', 'Wallpaper=%%SystemRoot%%\web\wallpaper\Windows\atlas-dark.jpg'; $Content = $Content -replace 'SystemMode=.*', """"SystemMode=Dark`nAppMode=Dark"""" | Set-Content '!windir!\Resources\Themes\aero.theme'"
@REM )
...
@REM if not exist "!windir!\Web\Wallpaper\Windows\atlas-dark.jpg" exit /b 1

@REM reg add "HKEY_USERS\%~1\Control Panel\Desktop" /v "WallPaper" /t REG_SZ /d "!windir!\Web\Wallpaper\Windows\atlas-dark.jpg" /f
@REM reg add "HKCU\Control Panel\Desktop" /v "Wallpaper" /t REG_SZ /d "!windir!\Web\Wallpaper\Windows\atlas-dark.jpg" /f
